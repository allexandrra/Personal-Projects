...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	angularStepOYPlanet += deltaTimeSeconds * 90;

	modelMatrix = glm::mat4(1);
	//angularStepOZ += deltaTimeSeconds * 90;
	//modelMatrix *= Transform3D::RotateOZ(3.14 * angularStepOZ / 180);
	//modelMatrix *= Transform3D::Translate(-2.5f, 0.5f,-1.5f);
	modelMatrix *= Transform3D::Scale(scaleX - 0.4, scaleY - 0.4, scaleZ - 0.4);
	modelMatrix *= Transform3D::RotateOY(3.14 * angularStepOYPlanet / 180);
	//modelMatrix *= Transform3D::Translate(translateX, translateY, translateZ);
	RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

	modelMatrix = glm::mat4(1);
	modelMatrix *= Transform3D::RotateOY(3.14 * angularStepOYPlanet / 180);
	modelMatrix *= Transform3D::Translate(2.0f, 0.0f, 0.0f);
	modelMatrix *= Transform3D::Scale(scaleX - 0.4, scaleY - 0.4, scaleZ - 0.4);
	modelMatrix *= Transform3D::RotateOY(3.14 * angularStepOYPlanet / 180);
	...
	//modelMatrix *= Transform3D::RotateOZ(3.14 * angularStepOZ / 180);
	modelMatrix *= Transform3D::Translate(2.0f, 0.0f, 0.0f);
	modelMatrix *= Transform3D::Scale(scaleX - 0.6, scaleY - 0.6, scaleZ - 0.6);
	modelMatrix *= Transform3D::RotateOY(3.14 * angularStepOYPlanet / 180);
