...
namespace Lab
{
	...
	public:
		...
		void RotateFirstPerson_OX(float angle)
		{
			...
			// Use glm::rotate()
			glm::vec4 newVector = glm::rotate(glm::mat4(1.0f), angle, right) * glm::vec4(forward, 1.0f);
		...
		void RotateFirstPerson_OY(float angle)
		{
			...
			// Use glm::rotate()
			glm::vec4 newVector = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1.0f);
			forward = glm::normalize(glm::vec3(newVector));
			glm::vec4 newVector2 = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1.0f);
		...
		void RotateFirstPerson_OZ(float angle)
		{
			...
			// Don't forget to normalize the vectors
			glm::vec4 newVector2 = glm::rotate(glm::mat4(1.0f), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1.0f);
			right = glm::normalize(glm::vec3(newVector2));
			up = glm::cross(right, forward);
		}
		...
		void setNewDistanceToTarget(float dist) {
