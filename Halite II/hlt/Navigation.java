...
public class Navigation {
    ...
    //facuta de mine
    public static ThrustMove navigateShipToAttack(final GameMap gameMap, final Ship ship, final Entity enemyTarget, final int maxThrust) {
        final int maxCorrections = Constants.MAX_NAVIGATION_CORRECTIONS;
        final boolean avoidObstacles = true;
        final double angularStepRad = Math.PI/180.0;
        final Position targetPos = ship.getClosestPoint(enemyTarget);
